...
fun WhatsAppStatus() {
    ...
    val listOfViewedData = listOf(
        SampleData("Viewed 1", "Android Jetpack Compose 1", "Sample Url", strDate),
        SampleData("Viewed 2", "Android Jetpack Compose 2", "Sample Url", strDate),
        SampleData("Viewed 3", "Android Jetpack Compose 3", "Sample Url", strDate),
        SampleData("Viewed 4", "Android Jetpack Compose 4", "Sample Url", strDate),
        SampleData("Viewed 5", "Android Jetpack Compose 5", "Sample Url", strDate),
        SampleData("Viewed 6", "Android Jetpack Compose 6", "Sample Url", strDate),
        SampleData("Viewed 7", "Android Jetpack Compose 7", "Sample Url", strDate),
    )
    LazyColumn(
        modifier = Modifier
...
@Composable
fun SampleViewedListItem(data: SampleData) {
}